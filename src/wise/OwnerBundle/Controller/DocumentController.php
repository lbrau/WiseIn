...
use wise\OwnerBundle\Entity\Document;
...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $documents = $em->getRepository('wiseOwnerBundle:Document')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('wise\OwnerBundle\Form\DocumentType', $document);
    ...
    {
        $deleteForm = $this->createDeleteForm($document);
        $editForm = $this->createForm('wise\OwnerBundle\Form\DocumentType', $document);
