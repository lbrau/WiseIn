...
use wise\OwnerBundle\Entity\Message;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $messages = $em->getRepository('wiseOwnerBundle:Message')->findBy(array('proprietaire'));
        dump(messages);
//        return $this->render('message/index.html.twig', array(
//            'messages' => $messages,
//        ));
        return $this->render('@wiseOwner/header/bo_header.html.twig', array(
            'messages' => $messages,
        ));
    }
    ...
    {
        $message = new Message();
        $form = $this->createForm('wise\OwnerBundle\Form\MessageType', $message);
    ...
    {
        $deleteForm = $this->createDeleteForm($message);
        $editForm = $this->createForm('wise\OwnerBundle\Form\MessageType', $message);
