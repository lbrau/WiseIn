...
use wise\OwnerBundle\Entity\Annonce;
...
class AnnonceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $annonces = $em->getRepository('wiseOwnerBundle:Annonce')->findAll();
    ...
    {
        $annonce = new Annonce();
        $form = $this->createForm('wise\OwnerBundle\Form\AnnonceType', $annonce);
    ...
    {
        $deleteForm = $this->createDeleteForm($annonce);
        $editForm = $this->createForm('wise\OwnerBundle\Form\AnnonceType', $annonce);
